        ...
        <div className = "about-container"> 
            ...
            <div className = "text-container"> 
                <div className = "description">
                    <p>Hi! My name is Jacqueline and I'm currently an undergraduate student at the University of Waterloo studying Software Engineering.</p>
                    ...
                    <p>In my free time, you can find me scrolling endlessly on pinterest or curating another spotify playlist!</p>
                </div>
            </div>  
        </div>
    </div>
